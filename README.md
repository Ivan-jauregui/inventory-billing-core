...
* **Reference-Based Stock Management:** Uses a high-performance memory structure to handle stock mutations safely without duplicating entity overhead.
...
* **DRY Principle (Don't Repeat Yourself):** Reuses internal lookup utilities (`findProductById`) to streamline inventory mutations.
